    ...
    public partial class Tab3 : Form
    {
        ...
        private void Tab3_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                adapter = new MySqlDataAdapter("Select * from `поставщики` order by `Поставщик`", connection);
        ...
        private void Tab3_FormClosing(object sender, FormClosingEventArgs e)
        {
            connection.Close();          
        }
        ...
        void loaddata()
        {
            adap = new MySqlDataAdapter("Select * From `поставщики` order by `Поставщик`", connection);
        ...
        private void delete(object sender, EventArgs e)
        {
            ...
            if (dialogResult == DialogResult.Yes)
            {
                ...
                {
                    string sql = "Delete From `поставщики` where " +
                        $"`№ поставщика`='{dataGridView1.SelectedRows[i].Cells[0].Value.ToString()}'";
